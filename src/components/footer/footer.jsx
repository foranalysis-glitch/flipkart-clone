function Footer() {
  return (
    <footer className="bg-[royalblue] text-white mt-8">
      <div className="max-w-7xl mx-auto px-5 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p  className="text-sm text-gray-300 font-bold-400">  Contact Us</p>
            <p className="text-sm text-gray-300 font-bold-400">Careers</p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">Terms Of Use</p>
